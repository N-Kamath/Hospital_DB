...
public class UserDao {
	...
	public boolean register(User u) {
		...
		System.out.println();
		try {
			String sql = "insert into patientview1(PATIENTID,FIRSTNAME,LASTNAME,DOB,GENDER,EMAIL,PHONE,ADDRESS,SSN,COVIDSTATUS,INSURANCEID) values(?,?,?,?,?,?,?,?,?,?,?) ";

			PreparedStatement ps = conn.prepareStatement(sql);
			ps.setString(1, u.getPATIENTID());
